defmodule Webhooks.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Webhooks.Repo)
  ...
  """
  def valid_password?(%Webhooks.Accounts.User{hashed_password: hashed_password}, password)
