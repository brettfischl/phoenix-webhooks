defmodule Webhooks.Accounts do
  @moduledoc """
  ...
  def get_user_by_email_and_password(email, password)
    when is_binary(email) and is_binary(password) do
      user =
        ...
        |> Repo.preload(organization: from(o in Webhooks.Accounts.Organization, where: o.is_current == true))
  ...
  @doc """
  Returns the list of user_organizations.

  ## Examples

      iex> list_user_organizations()
      [%UserOrganization{}, ...]

  """
  def list_user_organizations do
    Repo.all(UserOrganization)
  end

  @doc """
  Gets a single user_organization.
